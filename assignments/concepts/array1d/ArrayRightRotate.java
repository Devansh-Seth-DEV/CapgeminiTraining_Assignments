...
public class ArrayRightRotate {
	public static void main(String[] args) {
		...
		for(int i=1; i<=3; i++) {
			...
			rightRotateArray(arr, 1);
			System.out.println("Array after right rotate elements by " + i + ":");
			printArray(arr);
		}
	...
	public static void rightRotateArray(int[] array, int bits) {
		for(int i=0; i<array.length; i++)
			array[i] = rightRotate(array[i], bits);
	}
